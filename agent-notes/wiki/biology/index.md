...
Cell biology, genetics, evolution, and the mechanisms of life.

## Articles
- [[cellular-memory]] — cells can "remember" without a nervous system: the spacing effect in kidney cells, a century of dismissed single-cell learning research, and redefining memory as a basic property of life
- [[plant-memory]] — habituation in *Mimosa pudica*, associative learning in peas, vernalization as epigenetic memory, the Lysenko shadow, and the adaptive case for forgetting
...
- [[developmental-bioelectricity]] — Levin lab: voltage gradients across non-neural tissue store a target morphology that cells error-minimize toward; ectopic eyes from gut cells, two-headed planaria without genome edits, 24-hour induction of frog limb regeneration, HCN2 rescue of notch-mutant brains; aging as blurring of that pattern, with a speculative cognitive/cybernetic ultimate cause (goal-directed systems degrade after their goals are met) and atavistic dissociation of transcriptomic evolutionary age as the downstream consequence
